...
public class TestFifoQueue {
	...
	@Test
	public final void testIteratorPrintLoop() {
		myIntQueue.offer(1);
		myIntQueue.offer(2);
		myIntQueue.offer(3);
		myIntQueue.offer(4);
		
		Iterator<Integer> it = myIntQueue.iterator();
	...
	/**
	 * Test Iterator empty queue.
	 */
	@Test
	public final void testIteratorEmptyQueue() {
		Boolean actualValue = myIntQueue.iterator().hasNext();
		assertFalse("The Iterator does not return false when initiated; it thinks it has nodes", actualValue);
	}
	
	
	@Test(expected = NoSuchElementException.class)
	public final void testIteratorEmptyQueueWithException(){
		myIntQueue.iterator().next();
